{
  ...
  # ============================================================================
  # Target Drive: WD Blue SN5100 1TB NVMe SSD referenced by persistent hardware ID
  # to avoid device node renumbering (/dev/nvmeXn1) across kernel boots.
  disko.devices = {
    disk = {
      main = {
        type = "disk";
          ...
          partitions = {
            ...
            ESP = {
              ...
              content = {
                ...
                # kernel images, initrd secrets, and bootloader configuration
              ...
              content = {
                ...
                content = {
                  ...
                  subvolumes = {
                    ...
                    "@" = {
                      mountpoint = "/";
                      # zstd provides transparent on-the-fly compression;
                    ...
                    # Nix store: Isolated so package builds and garbage collection don't pollute root snapshots
                    "@nix" = {
                      mountpoint = "/nix";
                      mountOptions = [ "compress=zstd" "noatime" ];
                    };
